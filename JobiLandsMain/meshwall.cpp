...
void InitMeshWall(void)
{
	...
	//壁の設置
	SetMeshWall(D3DXVECTOR3(-1500.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, -D3DX_PI * 0.5f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(1500.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, D3DX_PI * 0.5f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(0.0f, 0.0f, 1500.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(0.0f, 0.0f, -1500.0f), D3DXVECTOR3(0.0f, D3DX_PI, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(1250.0f, 0.0f, -1250.0f), D3DXVECTOR3(0.0f, D3DX_PI * 0.75f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(-1250.0f, 0.0f, -1250.0f), D3DXVECTOR3(0.0f, -D3DX_PI * 0.75f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(-1250.0f, 0.0f, 1250.0f), D3DXVECTOR3(0.0f, -D3DX_PI * 0.25f, 0.0f), 8, 2);
	SetMeshWall(D3DXVECTOR3(1250.0f, 0.0f, 1250.0f), D3DXVECTOR3(0.0f, D3DX_PI * 0.25f, 0.0f), 8, 2);
	//SetMeshWall(D3DXVECTOR3(200.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 1, 1);
...
void UpdateMeshWall(void)
{
	...
	//g_aMeshWall[4].rot.y += 0.005f;

	////角度の正規化
	//g_aMeshWall[4].rot.y = RotNormalize(g_aMeshWall[4].rot.y);
}
