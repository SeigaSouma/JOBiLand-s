...
//ゲームパッドのリピート処理
//==================================================================================
bool GetGamepadRelease(int nKey, int nCntPlayer)
{
...
D3DXVECTOR3 GetStickMoveL(int nCntPlayer)
{
	...
	D3DXVECTOR3 StickMoveL = 
		D3DXVECTOR3(
			(float)g_aGamepadState[nCntPlayer].Gamepad.sThumbLX * 0.001f,
			0.0f,
			(float)g_aGamepadState[nCntPlayer].Gamepad.sThumbLY * 0.001f);
...
D3DXVECTOR3 GetStickMoveR(int nCntPlayer)
{
	...
	D3DXVECTOR3 StickMoveR =
		D3DXVECTOR3(
			(float)g_aGamepadState[nCntPlayer].Gamepad.sThumbRX * 0.001f,
			0.0f,
			(float)g_aGamepadState[nCntPlayer].Gamepad.sThumbRY * 0.001f);
