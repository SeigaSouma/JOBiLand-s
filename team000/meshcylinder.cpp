...
#define POS_MESHCYLINDER_Y	(3000.0f)
#define MOVE		(0.0f)
#define WIDTH		(16)
#define HEIGHT		(1)
...
void InitMeshCylinder(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\city001.png",
		&g_pTextureMeshCylinder);

	//各要素初期化
	g_aMeshCylinder.pos = D3DXVECTOR3(0.0f, 0.0f, 0.0f);		//位置
	g_aMeshCylinder.rot = D3DXVECTOR3(0.0f, 0.0f, 0.0f);		//向き
