...
void InitShadow(void)
{
	...
	//ファイル数分繰り返す
	for (int nCntTex = 0; nCntTex < (sizeof c_apFilenameShadow) / sizeof(*c_apFilenameShadow); nCntTex++)
	{
		//テクスチャの読み込み
		D3DXCreateTextureFromFile(pDevice,
			c_apFilenameShadow[nCntTex],
			&g_apTextureShadow[nCntTex]);
	}
...
void SetPositionShadow(int nIdxShadow, D3DXVECTOR3 pos)
{
	...
	{
		g_aShadow[nIdxShadow].pos = D3DXVECTOR3(pos.x, 0.2f, pos.z);
	}
}
